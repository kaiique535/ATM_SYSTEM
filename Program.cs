    ...
    while (openApp) {
      ...
      case 1:
        ...
        if ((withdrawValue == 1) || (withdrawValue ==3 )){
          Console.WriteLine("It is not possible to withdraw 1R$ or 3R$, enter another valid amount:");
        }
        ...
        if ((isValidNumber == true) && (withdrawValue > 0) && (withdrawValue <= balanceAmount)) {
